        ...
        <div id="date" class="on">
          <div class="date_main clearfix">
            <div class="date_left">
              ...
              <div class="main">
                <p class="month" id="month">三月</p>
                <p class="date" id="day">19</p>
              </div>
            </div>
            <div class="date_right">
              <p class="time" id="time">21 : 39 : 47</p>
              <p class="date" id="year">2021年03月19日</p>
              <p class="week" id="week">星期五</p>
            </div>
          </div>
...

      {
        ...
        this.$jq.ajax({
          ...
          data: {
            ...
            "showapi_appid": 612226,
            "showapi_sign": 'cdab761328ac42298c3c4600a933e2de',
            "area":this.location,
          },
...
<style scoped lang="less">
  ...
  .bg{
    height: 100%;
    background-image: -webkit-linear-gradient(top, #394984, #edb46d) !important;
  }
  .weather{
    padding-top: 10/@rem;
    zoom: 1;
